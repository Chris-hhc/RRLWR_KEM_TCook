  ...
  unsigned char *ct, unsigned long long *ct_len_bytes)
{
  ...
  // Hash the PKE public key
  RRLWR_KEM_HASH_F(hpk, pk, RRLWR_PKE_PK_LEN);

  // Hash (K, seedSp) = H(H(pk), m)
  RRLWR_KEM_HASH_G(K_seedSp, RRLWR_KEM_SS_LEN + RRLWR_SEED_S_LEN, hpk_m, RRLWR_KEM_HPK_LEN + RRLWR_PKE_MESSAGE_LEN);
  ...
  unsigned char *ss, unsigned long long *ss_len_bytes)
{
  ...
  unsigned char ct_z[RRLWR_KEM_CT_LEN + RRLWR_KEM_SEED_Z_LEN];                       // (ct, z)
  unsigned char *z = ct_z + RRLWR_KEM_CT_LEN;                                        // RRLWR_KEM_SEED_Z_LEN
  ...
  // Hash (K, seedSp) = H(H(pk), m)
  RRLWR_KEM_HASH_G(K_seedSp, RRLWR_KEM_SS_LEN + RRLWR_SEED_S_LEN, hpk_mp, RRLWR_KEM_HPK_LEN + RRLWR_PKE_MESSAGE_LEN);
